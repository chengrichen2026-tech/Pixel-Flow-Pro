...
test("user-facing documentation matches the packaged version and task model", async () => {
  ...
  assert.match(partnerGuide, /生图模式选择“Team Cloud”，模型选择 Flare 或 Sunburst/);
...
test("HTML guide navigation and local images resolve", async () => {
  ...
  assert.match(html, /<title>Pixel Flow v0\.3\.14 使用说明（2026-09-15 更新）<\/title>/);
  assert.match(html, /<footer>Pixel Flow · AI 创意任务画布 · v0\.3\.14 · 2026-09-15/);
