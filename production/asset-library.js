(() => {
  ...
  function formTemplate(root = panel) {
    ...
    return {
      ...
      count: Math.min(4, Math.max(1, Number(data.get("count") || 1))), generationMode: ["browser", "team"].includes(String(data.get("generationMode"))) ? String(data.get("generationMode")) : "api"
    };
  }
